import 'package:cat_facts/core/data/network/helper/headers_utils.dart';
  ...
  Future<Response> get(apiName,
    ...
    try {
      ...
      if (e is DioException) {
        ...
        throw ServerException(0, 'There is some Technical error. please try again');
      }
    }
  }
...
late RestClient catFactRestClient;

void init(String catFactBaseURL) {
  initCatFactRestClient(catFactBaseURL);
}

void initCatFactRestClient(String catFactBaseURL) {
  catFactRestClient = RestClient(catFactBaseURL);
}
